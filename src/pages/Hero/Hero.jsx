...
const profile = {
    name: 'Hirwa Pie',
    title: 'Full-Stack Developer | Cybersecurity Enthusiast | Problem Solver',
    skills: [
        'JavaScript', 'React', 'Laravel', 'Python',
        'Node.js', 'Metsploit', 'Git', 'Nmap'
    ],
    hobbies: ['Playing the guitar', 'Gaming', 'Anime', 'Hackathons'],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
    yearsOfExperience: 3,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  JavaScript & Python enthusiast 🚀 | PieBot creator 🔧 | Building
                  scalable apps and securing systems 💻✨
                </p>
              </div>
              ...
              <div className="hidden lg:block absolute right-10 top-20 animate-float">
                <div className="px-4 py-2 rounded-lg bg-blue-500/10 backdrop-blur-sm border border-blue-500/20 text-blue-400">
                  <i className="fas fa-code"></i>&nbsp;&nbsp;Secure Code
                </div>
              </div>
